...
with Engine(custom_parser=parser) as engine:
    ...
    for epoch in range(engine.state.epoch, config.nepochs):
        ...
        for idx in pbar:
            ...
            #cps_loss = criterion(logits_cons_stu_1, ps_label_2) + criterion(logits_cons_stu_2, ps_label_1) # pred:[BS,3,512, 512] gt: [BS,512, 512]
            ...
            '''
            print("pred", logits_cons_stu_1)
            print("pseudo", ps_label_2)
            print("pred1", sup_pred_l)
            print("pred2", sup_pred_r)
            print("gt", gts)
            '''
