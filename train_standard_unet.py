...
optimizer = optim.Adam(standard_unet_model.parameters(), lr = 0.0003, weight_decay=1e-5)
lr_schedule = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[6, 12, 18, 24], gamma=0.4)
